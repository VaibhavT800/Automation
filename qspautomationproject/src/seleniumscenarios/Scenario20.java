	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(3000);
		 ...
		 act.moveToElement(TargetToMouseHover).perform();
		  ...
		  WebElement TargetToMouseHover1 = driver.findElement(By.xpath("//div[@class='filter 10gms']"));
			 Actions act1=new Actions(driver);
			 act.moveToElement(TargetToMouseHover1).perform();
			 driver.findElement(By.xpath("https://kinclimg6.bluestone.com/f_webp,c_scale,w_515,b_rgb:ffffff/product/10gms995LM_YAA24XXXXXXXXXXXX_ABCD00-fr-1024-v5.jpg")).click();
